...
//	PID_ControllerInit(&auto_pit,50,50,10,0.001);
    ...
    PID_SetGains(&auto_yaw,0.0224,0,0);//0.0224//0.000018);//0.0025,0.001,0 0.0025,0,0.000008


#ifdef INFANTRY_Jiangsu
    PID_SetGains(&auto_pit,0.15,0,0.001);//0.0086,0,0
#endif
...
//
        YawTarget.Gyroscope+=auto_aim_yaw_temp;
				//PitchTarget.Mechanical-=0.001f	*	(RC_Ex_Ctl.rc.ch3)+ MOUSE_PIT_SPEED * RC_Ex_Ctl.mouse.y;
